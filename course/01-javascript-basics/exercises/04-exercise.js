...
function isUrgent(task) {
  if (task.important === true && task.done === false) {
    return true;
  } else {
    return false;
  }
...
const task = {text: "Buy groceries", important: true, done: false }

console.log(isUrgent(task));